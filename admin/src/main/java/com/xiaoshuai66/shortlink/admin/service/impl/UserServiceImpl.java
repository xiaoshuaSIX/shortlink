...
import static com.xiaoshuai66.shortlink.admin.common.constant.RedisCacheConstant.LOCK_USER_REGISTER_KEY;
import static com.xiaoshuai66.shortlink.admin.common.constant.RedisCacheConstant.USER_LOGIN_KEY;
import static com.xiaoshuai66.shortlink.admin.common.enums.UserErrorCodeEnum.*;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, UserDO> implements UserService {
    ...
    public UserLoginRespDTO login(UserLoginRepDTO requestParam) {
        ...
        stringRedisTemplate.opsForHash().put(USER_LOGIN_KEY + requestParam.getUsername(), uuid, JSON.toJSON(userDO));
        stringRedisTemplate.expire(USER_LOGIN_KEY + requestParam.getUsername(), 30L, TimeUnit.MINUTES);
